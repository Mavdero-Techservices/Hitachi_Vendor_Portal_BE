...
router.get(
  "/signUp/signupFindSubUserList/:userId",
  signUp.signupFindSubUserList
);
//login
...
router.get(
  "/getErpVendorMasterIntegration",
  tutorialApi.getErpVendorMasterIntegration
);
//postErpTestingOData
...
router.post(
  "/postErpVendorMasterIntegration",
  tutorialApi.postErpVendorMasterIntegration
);
//getErpById
...
router.put(
  "/updateErpVendorMasterIntegration",
  tutorialApi.updateErpVendorMasterIntegration
);
//Retrieve all data
...
router.get(
  ...
  vdetail.getStateAndcityByzipcode
);
...
router.put(
  "/updateComplianceDetail/:userId",
  compDetail.updateComplianceDetail
);

router.post(
  "/createRelatedDisclosurePdf",
  compDetail.createRelatedDisclosurePdf
);
...
router.put(
  ...
  approvalStatus.updateApprovalStatus
);
...
router.post(
  "/saveMasterVendorSubUser",
  MasterVendorSubUser.saveMasterVendorSubUser
);
router.post(
  "/getMasterVendorSubUserById",
  MasterVendorSubUser.getMasterVendorSubUserById
);
router.get(
  "/getAllMasterVendorSubUser",
  MasterVendorSubUser.getAllMasterVendorSubUser
);

router.put(
  "/UpdateMasterSubUserById",
  MasterVendorSubUser.UpdateMasterSubUserById
);

router.put(
  "/UpdateMasterVendorSubUserById",
  MasterVendorSubUser.UpdateMasterVendorSubUserById
);
router.delete(
  "/deleteMasterVendorSubUserById/:id",
  MasterVendorSubUser.deleteMasterVendorSubUserById
);
router.get("/getAllVendorSubUser", MasterVendorSubUser.getAllVendorSubUser);

router.post(
  "/saveMasterVendorUserAccess",
  MasterVendorUserAccess.saveMasterVendorUserAccess
);
router.post(
  "/getMasterVendorUserAccessById",
  MasterVendorUserAccess.getMasterVendorUserAccessById
);
router.get(
  "/getAllMasterVendorUserAccess",
  MasterVendorUserAccess.getAllMasterVendorUserAccess
);
router.put(
  "/UpdateMasterVendorUserAccessById",
  MasterVendorUserAccess.UpdateMasterVendorUserAccessById
);
router.delete(
  "/deleteMasterVendorUserAccessById/:id",
  MasterVendorUserAccess.deleteMasterVendorUserAccessById
);

router.post(
  "/accountStatementApproval/save",
  accountStatementApproval.saveAccountApprovalStatus
);
router.put(
  "/accountStatementApproval/update/:id",
  accountStatementApproval.updateAccountApprovalStatus
);
router.get(
  "/accountStatementApproval/findAll",
  accountStatementApproval.getAccountApprovalList
);
router.get(
  "/accountStatementApproval/exportExcel/:vendorCode",
  accountStatementApproval.downloadAccountItemExcel
);

router.get(
  "/downloadCurrentAccountStatement/exportExcel",
  accountStatementApproval.downloadAccountItemExcel
);
router.post(
  "/approveAccStatementDetail",
  accountStatementApproval.approveAccStatementDetail
);
router.post(
  "/rejectAccStatementDetail/:No",
  accountStatementApproval.rejectAccStatementDetail
);
router.get(
  "/downloadAccStatementConfirmation/exportExcel",
  accountStatementApproval.downloadAccStateExcel
);

router.post(
  "/purchaseOrderEstimate/save",
  purchaseOrder.savePurchaseOrderEstimateDate
);
router.get(
  "/purchaseOrderEstimate/findAll",
  purchaseOrder.getPurchaseOrderEstimateDateList
);
...
router.get(
  ...
  ErpAccess.getErpResourcePortalVendorlist
);
router.get(
  "/getErpResourcePortalVendorlistById/:Vendor_No",
  ErpAccess.getErpResourcePortalVendorlistById
);
router.post(
  "/postErpResourcePortalVendorlist",
  ErpAccess.postErpResourcePortalVendorlist
);
...
router.put(
  "/updateErpResourcePortalVendorlist/:Refrence_Entry_No",
  ErpAccess.updateErpResourcePortalVendorlist
);
router.get(
  "/getErpVendor_APIByParent_Vendor_Code/:Parent_Vendor_Code",
  ErpAccess.getErpVendor_APIByParent_Vendor_Code
);
router.get(
  "/getErpVendor_APIByP_A_N_No/:Ticket_ID",
  ErpAccess.getErpVendor_APIByP_A_N_No
);
router.post("/saveMasterLogin", signUp.saveMasterLogin);
router.get(
  "/verifyUSerByMail/:mastervendor_email/:mailConfirmationCode",
  signUp.verifyUserByMail
);
...
router.get(
  "/getUpdatePoPage/:level2ApprovalStatus/:No",
  poTeam.getUpdatePoPage
);
router.get(
  "/getUpdatePoInvoicePage/:level1ApprovalStatus/:No",
  poTeam.getUpdatePoInvoicePage
);
router.get(
  "/updatePoInvoiceByMail/:level1ApprovalStatus/:No",
  poTeam.updatePoInvoiceByMail
);
//getpo
...
router.put(
  "/updateFinanceInvoiceApproval",
  poTeam.updateFinanceInvoiceApproval
);
