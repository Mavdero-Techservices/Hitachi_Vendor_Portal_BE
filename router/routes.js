...
const agreement = require("../controller/agreement.controller")
...
router.get('/getSignUpDetails', signUp.getSignUpDetails);
...
router.post("/saveAgreement", agreement.saveAgreementDoc);
router.get("/getAgreement", agreement.getAgreementDocList);
