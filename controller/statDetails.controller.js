...
<<<<<<< Updated upstream
    ...
    if (file.fieldname === "fileDisclosure") {
      ...
      if (file.mimetype === "image/jpeg") {
        filetype = "jpg";
        fileDisclosure =
          "../uploads/" + "fileDisclosure-" + Date.now() + "." + filetype;
      }
      if (file.mimetype === "application/pdf") {
        filetype = "pdf";
        fileDisclosure =
    ...
    if (file.fieldname === "form_10f_Doc") {
      ...
      if (file.mimetype === "image/jpeg") {
        filetype = "jpg";
        form_10f_DocPath =
          "../uploads/" + "form_10f_Doc-" + Date.now() + "." + filetype;
      }
      if (file.mimetype === "application/pdf") {
        filetype = "pdf";
        form_10f_DocPath =
    ...
    if (file.fieldname === "PE_Declaration_Doc") {
      ...
      if (file.mimetype === "image/jpeg") {
        filetype = "jpg";
        PE_Declaration_DocPath =
          "../uploads/" + "PE_Declaration_Doc-" + Date.now() + "." + filetype;
      }
      if (file.mimetype === "application/pdf") {
        filetype = "pdf";
        PE_Declaration_DocPath =
    ...
    if (file.fieldname === "MSME_Doc") {
      ...
      if (file.mimetype === "image/jpeg") {
        filetype = "jpg";
        MSME_DocPath =
          "../uploads/" + "MSME_Doc-" + Date.now() + "." + filetype;
      }
      if (file.mimetype === "application/pdf") {
        filetype = "pdf";
        MSME_DocPath =
    ...
    if (file.fieldname === "Tax_residency_Doc") {
      ...
      if (file.mimetype === "image/jpeg") {
        filetype = "jpg";
        Tax_residency_DocPath =
          "../uploads/" + "Tax_residency_Doc-" + Date.now() + "." + filetype;
      }
      if (file.mimetype === "application/pdf") {
        filetype = "pdf";
        Tax_residency_DocPath =
