...
exports.getErpVendor_APIById = (req, res) => {
  ...
  httpntlm.get(
    {
      url:
        "http://10.83.152.111:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/Vendor_API?$format=json&$filter=No eq '" +
        No +
        "'",
      username: "ERP-API",
      password: "HSI@#543DCVB",
...
exports.updateErpVendor_API = (req, res) => {
  ...
  const url1 =
    "http://dnav-appserver.microclinic.in:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/Vendor_API?$format=json&$filter=Parent_Vendor_Code%20eq%20A0029";
  httpntlm.get(
    {
      url: url1,
      username: "ERP-API",
    ...
    function (err, result) {
      if (err) {
        ...
        const url2 =
          "http://dnav-appserver.microclinic.in:4049/NAVTestDB2/OData/Vendor_API(Parent_Vendor_Code=A0029)?company=Hitachi%20Systems%20India%20Pvt%20Ltd";
        const payload = {
          Ticket_ID: "",
        };
...
exports.updateErpResourcePortalVendorlist = (req, res) => {
  ...
  const url1 =
    "http://dnav-appserver.microclinic.in:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/APITestingOData?$format=json&$filter=Entry_No%20eq%2016";
  httpntlm.get(
    {
      url:
        "http://10.83.152.111:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/ResourcePortalVendorlist1?$format=json&$filter=Refrence_Entry_No eq '" +
        Refrence_Entry_No +
        "'",
      username: "ERP-API",
      password: "HSI@#543DCVB",
    ...
    function (err, result) {
      if (err) {
        ...
        console.log("ETag", ETag);
        const url2 =
          "http://dnav-appserver.microclinic.in:4049/NAVTestDB2/OData/APITestingOData(Entry_No=16)?company=Hitachi%20Systems%20India%20Pvt%20Ltd";
        const payload = {
...
exports.postErpResourcePortalVendorlist = (req, res) => {
  const odataUrl =
    "http://10.83.152.111:4049/NAVTestDB2/OData/ResourcePortalVendorlist1?$format=json&company=Hitachi%20Systems%20India%20Pvt%20Ltd";
  const data = req.body;
  httpntlm.post(
    {
      url: odataUrl,
...
exports.getErpVendor_APIByParent_Vendor_Code = (req, res) => {
  ...
  httpntlm.get(
    {
      url:
        "http://10.83.152.111:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/Vendor_API?$format=json&$filter=Parent_Vendor_Code eq '" +
        Parent_Vendor_Code +
        "'",
      username: "ERP-API",
      password: "HSI@#543DCVB",
...
exports.getErpVendor_APIByP_A_N_No = (req, res) => {
  ...
  httpntlm.get(
    {
      url:
        "http://10.83.152.111:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/ResourcePortalVendorlist1?$format=json&$filter=Entry_No eq '" +
        Ticket_ID +
        "'",
      username: "ERP-API",
      password: "HSI@#543DCVB",
      ...
      if (err) {
        ...
        if (data.length > 0) {
          ...
          httpntlm.get(
            {
              url:
                "http://10.83.152.111:4049/NAVTestDB2/OData/Company('Hitachi%20Systems%20India%20Pvt%20Ltd')/Vendor_API?$format=json&$filter=P_A_N_No eq '" +
                P_A_N_No +
                "'",
              username: "ERP-API",
              password: "HSI@#543DCVB",
          ...
          res
            .status(200)
            .json({ message: "No record found for the given Ticket_ID" });
        }
      }
    }
  );
